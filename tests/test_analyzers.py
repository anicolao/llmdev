...
"""
    ...
    def test_analyze_pr_complete(self):
        ...
        commits = [
            {'sha': 'abc123', 'message': 'Initial implementation', 'date': datetime(2024, 1, 1, 10, 30)},
...
class TestIterationAnalyzer:
    ...
    def test_classify_quick_win(self):
        ...
        commits = [
            {'sha': 'abc', 'message': 'Implement feature', 'date': datetime.now()}
        ]
...
"""
    ...
    def test_extract_prompt_patterns(self):
        ...
        prompts = [
            {'specificity_score': 0.8, 'has_context': True, 'has_constraints': True, 'has_examples': True},
            {'specificity_score': 0.6, 'has_context': True, 'has_constraints': False, 'has_examples': False},
            {'specificity_score': 0.4, 'has_context': False, 'has_constraints': False, 'has_examples': False},
        ]
